One parameter of paramount importance in a [[Bravais lattice]] is the coordination number, i.e. the number of atoms that have the minimum distance from a given atom.
