One can consider the following probability density function associated to the random variable vector $\bar{x}=(x_1,x_2,\dots x_n)$ as an extension of the [[Gaussian probability density function]]:
