Suppose to extend in the continuum limit the considerations made upon the discrete master equation in [[Diffusion process in 1D - microscopic description]]. We begin by recalling it:
