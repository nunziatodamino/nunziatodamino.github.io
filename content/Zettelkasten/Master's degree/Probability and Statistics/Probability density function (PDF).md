In order to specify a [[random variable]] $X$, one can specify its probability density function, defined from the [[Zettelkasten/Master's degree/Probability and Statistics/Cumulative density function (CDF)]] as:
