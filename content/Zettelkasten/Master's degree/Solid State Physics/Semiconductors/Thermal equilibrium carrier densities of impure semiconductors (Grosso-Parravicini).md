We will treat here the case only of the n-type semiconductor ($N_a =0$) so that the [[Charge neutrality in a doped semiconductor|Charge neutrality condition]] becomes:
