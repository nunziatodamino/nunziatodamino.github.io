...
Where we first used the linearity property of the functional derivative and the Laplacian operator. Now, using the results found in [[Functional derivative|Functional derivative]], one has:
