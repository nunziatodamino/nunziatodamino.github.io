The [[Zettelkasten/Master's degree/Models of Theoretical Physics/Sokhotski–Plemelj formula]] is valid when the function present a single pole on the $x$ axis. 
