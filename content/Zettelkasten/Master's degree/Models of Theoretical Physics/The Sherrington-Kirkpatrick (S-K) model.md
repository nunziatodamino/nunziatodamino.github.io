Suppose to have a system behaving like the [[Zettelkasten/Master's degree/Models of Theoretical Physics/Hopfield model]], and suppose that the number of patterns is proportional to the number of neurons.
