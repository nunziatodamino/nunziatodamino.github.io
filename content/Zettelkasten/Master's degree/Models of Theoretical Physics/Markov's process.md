The Markov's process is an hypothesis done on a [[Zettelkasten/Master's degree/Models of Theoretical Physics/Discrete stochastic process]], in order to be able to study its dynamics. 
