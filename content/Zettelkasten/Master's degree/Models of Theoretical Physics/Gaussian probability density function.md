...
One can find the coefficient $C$ with the normalization condition $\int_{\mbox{sample space}}p_{X}(x)dx = 1$. We found, by using the [[Zettelkasten/Master's degree/Models of Theoretical Physics/Gaussian integrals]] that:
