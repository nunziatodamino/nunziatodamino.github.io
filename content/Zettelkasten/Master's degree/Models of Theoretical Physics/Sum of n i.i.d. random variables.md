Let's build the framework of the sum of $n$ random variables upon the work done on [[Zettelkasten/Master's degree/Models of Theoretical Physics/Sum of two i.i.d. random variables|2 variables]].
