...
This is straightforward, as we wrote them in the derivation of the [[Electromagnetic energy with respect to the vector potential in the Coulomb gauge]] (specifically [[Evaluation of the total energy of an e.m. field w.r.t the vector potential in the Coulomb gauge|here]]) respect the predecessor of the annihilation and creation operators:
...
$$ \hat{\bar{B}}(\bar{r},t) = i \sum_{\bar{k}}\sum_s  \sqrt{\frac{\hbar}{2\varepsilon_0\omega_{\bar{k}}V}}\ \left(\bar{k}\wedge \hat{\bar{\epsilon}}_{\bar{k},s}\right)
\left[
\hat{a}_{\bar{k},s}\,e^{i(\bar{k}\cdot\bar{r}-\omega_{\bar{k}}t)}
-
\hat{a}_{\bar{k},s}^{\dagger}\,e^{-i(\bar{k}\cdot\bar{r}-\omega_{\bar{k}}t)}
