We define lower critical dimension the dimension under which and at which the system does not display an ordered phase, i,e, is the dimension $d_C$ such that:
