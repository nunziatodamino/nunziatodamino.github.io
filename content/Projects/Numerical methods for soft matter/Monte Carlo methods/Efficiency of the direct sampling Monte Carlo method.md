Suppose One want to assign an accuracy to a MC method such as the [[Projects/Numerical methods for soft matter/Monte Carlo methods/Crude Monte Carlo|Crude Monte Carlo]].
