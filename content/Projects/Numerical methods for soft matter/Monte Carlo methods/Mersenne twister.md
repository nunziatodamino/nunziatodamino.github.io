The main idea is that one should use the Mersenne twister.
Python random library has this as default.
We report here an implementation in cpp
...
Mersenne twister is fast and has a period of $T \sim 2^{19937}-1$
