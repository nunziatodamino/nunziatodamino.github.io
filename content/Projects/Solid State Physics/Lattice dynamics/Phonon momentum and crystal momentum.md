We showed in [[Projects/Solid State Physics/Lattice dynamics/Phonon heat capacity in solids - Quantum treatment]] that a phonon has energy $\hbar \omega_{s}(\bar{k})$.
