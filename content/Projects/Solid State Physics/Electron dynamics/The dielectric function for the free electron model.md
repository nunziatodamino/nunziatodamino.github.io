Using the result derived in the [[Projects/Solid State Physics/Electron dynamics/Drude Theory]], we can write the dielectric function in the free electron approximation.
