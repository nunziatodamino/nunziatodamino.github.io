Suppose we want to expand on the idea of [[Projects/Solid State Physics/Electron dynamics/The tight-binding approach and its use cases|The tight-binding approach and its use cases]].
