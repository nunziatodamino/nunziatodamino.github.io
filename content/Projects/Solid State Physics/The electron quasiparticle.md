As seen in [[Thomas-Fermi model for screening]], or in [[Plasmons description using the Jellium model]], properties of an electron in a solid are vastly different from when is considered in vacuum.
